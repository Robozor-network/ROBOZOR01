...
teeth = 49;			// Number of teeth, standard Mendel T5 belt = 8, gives Outside Diameter of 11.88mm
profile = 3;		// 1=MXL 2=40DP 3=XL 4=H 5=T2.5 6=T5 7=T10 8=AT5 9=HTD_3mm 10=HTD_5mm 11=HTD_8mm 12=GT2_2mm 13=GT2_3mm 14=GT2_5mm

motor_shaft = 10;	// NEMA17 motor shaft exact diameter = 5
...
pulley_b_dia = 40;	// pulley base diameter, standard = 20
no_of_nuts = 4;		// number of captive nuts required, standard = 1
nut_angle = 90;		// angle between nuts, standard = 90
nut_shaft_distance = 3;	// distance between inner face of nut and shaft, can be negative.
